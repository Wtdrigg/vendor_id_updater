...
class Updater:
    ...
    # The switch_to_tab_1() method has the driver object switch to the first browser tab, which has Vcommerce loaded.
    def switch_tab_to_1(self):
        self.driver.switch_to.window(self.driver.window_handles[0])

    # The switch_to_tab_2() method has the driver object switch to the second browser tab, which has Riskonnect loaded.
    def switch_tab_to_2(self):
        self.driver.switch_to.window(self.driver.window_handles[1])

    # The switch_to_tab_3() method has the driver object switch to the third browser tab, which has the Vcommerce
